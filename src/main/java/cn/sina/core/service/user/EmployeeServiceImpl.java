package cn.sina.core.service.user;
...
import cn.sina.core.dao.user.EmployeeDao;
import cn.sina.core.domain.user.Employee;
import cn.sina.core.query.user.EmployeeQuery;
/**
 * 员工
 * @author lixu
