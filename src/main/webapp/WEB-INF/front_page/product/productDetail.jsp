...
function buy(productId){
	window.location.href='/cart/buy.shtml?skuId=' + skuId + "&amount=" + $("#num").val() + "&buyLimit=" + buyLimit + "&productId=" + productId;
...
<div class="w ofc mt">
	<div class="l">
		<div class="showPro">
			<div class="big">
				<a id="showImg" class="cloud-zoom" href="${product.img.fullPath }" rel="adjustX:10,adjustY:-1">
					<img width="200" height="250" src="${product.img.fullPath }">
				</a>
			</div>
		</div>
	</div>
	<div class="r" style="width: 640px">
		<ul class="uls form">
			...
			<li><label>巴  巴 价：</label><span class="word"><b class="f14 red mr" id="price"></b>(市场价:<del id="mprice"></del>)</span></li>
			<li><label>商品评价：</label><span class="word"><span class="val_no val3d4" title="4分">4分</span><var class="blue">(已有541人评价)</var></span></li>
			<li><label>运　　费：</label><span class="word" id="fee">10元</span></li>
			<li><label>库　　存：</label><span class="word" id="stock"></span><span class="word" >件</span></li>
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					<c:forEach items="${colors }" var="color">
					<a onclick="colorToRed(this,${color.id})" href="javascript:void(0)" title="${color.name }" class="changToWhite"><img width="25" height="25" data-img="1" src="/res/img/pic/qq.jpg" alt="${color.name } "><i>${color.name }</i></a>
					</c:forEach>
				</div>
			</li>
			<li id="sizes">
