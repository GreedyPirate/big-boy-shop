...
<%@ include file="/WEB-INF/back_page/date.jsp" %>
     <ul class="w-lful">
		...
		<li><a target="rightFrame" href="/order/list.do?isPaiy=3">已取消</a></li>
		<li><a target="rightFrame" href="/order/list.do?isPaiy=2">已付款</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=1">仓库配货</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=2">商品出库</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=3">等待收货</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=4">已完成</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=5">待退货</a></li>
		<li><a target="rightFrame" href="/order/list.do?isPaiy=3">待退款</a></li>
		<li><a target="rightFrame" href="/order/list.do?state=6">已退货</a></li>
